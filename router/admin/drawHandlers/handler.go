...
func List(c *gin.Context) {
	...
	list, count, err := draw.List(c, request.Page, request.PageSize)
	if err != nil {
...
func Add(c *gin.Context) {
	...
	err := draw.Add(c, request)
	if err != nil {
		logs.Error("draw create error: %v", err)
...
func Update(c *gin.Context) {
	...
	err := draw.Update(c, request)
	if err != nil {
		logs.Error("draw update error: %v", err)
...
func Delete(c *gin.Context) {
	...
	err := draw.Delete(c, id)
	if err != nil {
		logs.Error("draw delete error: %v", err)
